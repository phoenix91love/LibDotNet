...
namespace DapperCoreLib
{
    ...
    {
        private static Dictionary<Type, OracleDbType> OracleMappings = new Dictionary<Type, OracleDbType>
        {
            ...
            {typeof(bool),OracleDbType.Int16 }
        };

        public static OracleDbType? GuessType(Type type)
        {
