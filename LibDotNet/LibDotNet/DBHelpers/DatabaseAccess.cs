...
namespace LibDotNet.DBHelpers
{
    ...
    public static class DatabaseAccess<TDB> where TDB : DatabaseTypeBase, new()
    {
        ...
        /// <param name="connectionString">Connect string to server</param>
        ...
        public static async Task<IEnumerable<T>> QueryAsync<T>(string connectionString, string sql, object? parameters = null, int? commandTimeout = null, CommandType? commandType = CommandType.StoredProcedure, string[]? cusor = null)
        {
            try
            {
        ...
        /// <param name="cusor">Cusor with return data if use Oracle database</param>
        /// <returns>List data after query</returns>
        public static async Task<(IEnumerable<T1>, IEnumerable<T2>)> QueryAsync<T1, T2>(string connectionString, string sql, object? parameters = null, int? commandTimeout = null, CommandType? commandType = CommandType.StoredProcedure, string[]? cusor = null)
        {
            try
            {
                await using var connection = CreateConnection(connectionString);
        ...
        /// <param name="cusor">Cusor with return data if use Oracle database</param>
        /// <returns>List data after query</returns>
        public static async Task<(IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>)> QueryAsync<T1, T2, T3>(string connectionString, string sql, object? parameters = null, int? commandTimeout = null, CommandType? commandType = CommandType.StoredProcedure, string[]? cusor = null)
        {
            try
            {
                await using var connection = CreateConnection(connectionString);
        ...
        /// <param name="cusor">Cusor with return data if use Oracle database</param>
        /// <returns>List data after query</returns>
        public static async Task<(IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>, IEnumerable<T4>)> QueryAsync<T1, T2, T3, T4>(string connectionString, string sql, object? parameters = null, int? commandTimeout = null, CommandType? commandType = CommandType.StoredProcedure, string[]? cusor = null)
        {
            try
            {
                await using var connection = CreateConnection(connectionString);
        ...
        /// <param name="cusor">Cusor with return data if use Oracle database</param>
        /// <returns>List data after query</returns>
        public static async Task<(IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>, IEnumerable<T4>, IEnumerable<T5>)> QueryAsync<T1, T2, T3, T4, T5>(string connectionString, string sql, object? parameters = null, int? commandTimeout = null, CommandType? commandType = CommandType.StoredProcedure, string[]? cusor = null)
        {
            try
            {
                await using var connection = CreateConnection(connectionString);
        ...
        public static async Task<T?> QueryFirstOrDefaultAsync<T>(string connectionString, string sql, object? parameters = null, int? commandTimeout = null, CommandType? commandType = CommandType.StoredProcedure, string[]? cusor = null)
        {
            try
            {
                await using var connection = CreateConnection(connectionString);
        ...
        /// <param name="cusor">Cusor with return data if use Oracle database</param>
        /// <returns>Data after query</returns>
        public static async Task<T?> QueryFirstAsync<T>(string connectionString, string sql, object? parameters = null, int? commandTimeout = null, CommandType? commandType = CommandType.StoredProcedure, string[]? cusor = null)
        {
            try
            {
                await using var connection = CreateConnection(connectionString);
        ...
        /// <param name="cusor">Cusor with return data if use Oracle database</param>
        /// <returns>Data after query</returns>
        public static async Task<T?> QuerySingleOrDefaultAsync<T>(string connectionString, string sql, object? parameters = null, int? commandTimeout = null, CommandType? commandType = CommandType.StoredProcedure, string[]? cusor = null)
        {
            try
            {
                await using var connection = CreateConnection(connectionString);
        ...
        /// <returns></returns>
        public static async Task<T> ExecuteInTransactionAsync<T>(string connectionString, Func<TransactionScope<TDB>, Task<T>> operation, IsolationLevel isolationLevel = IsolationLevel.ReadCommitted)
        {
            await using var connection = CreateConnection(connectionString);
            ...
            try
            {
                var scope = TransactionScope<TDB>.Create(connectionString, transaction);
        ...
        /// <param name="isolationLevel"></param>
        /// <returns></returns>
        public static async Task ExecuteInTransactionAsync(string connectionString, Func<TransactionScope<TDB>, Task> operation, IsolationLevel isolationLevel = IsolationLevel.ReadCommitted)
        {
            await using var connection = CreateConnection(connectionString);
            await connection.OpenAsync();
            await using var transaction = await connection.BeginTransactionAsync(isolationLevel);
